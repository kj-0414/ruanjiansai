    ...
    <header class="app-header">
      ...
      <div class="header-right">
        <span class="user-info" @click="toggleUserMenu">
          ...
          <el-tag size="small" type="warning" class="role-tag">管理员</el-tag>
...
import {
  ArrowDown, HomeFilled, User, PieChart, Setting, Message,
